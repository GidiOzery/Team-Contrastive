...
class MOT(VideoDataset):
  ...
  def __init__(self, opt, split):
    ...
    elif self.dataset_version == '17trainval':
      ann_file = '{}.json'.format('train_interp')
    else:
      ann_file = '{}.json'.format('train_half_interp')
  ...
  def run_eval(self, results, save_dir, write_to_file=False, dataset_version=""):
