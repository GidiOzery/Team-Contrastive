...
# test
#CUDA_VISIBLE_DEVICES=0 python test.py tracking --exp_id mot17_with_contrastive_6400 --dataset mot --dataset_version test --track_thresh 0.4 --resume --is_recurrent --gru_filter_size 7 --num_gru_layers 1 --visibility_thresh_eval 0.1 --stream_test --ltrb_amodal --visibility --max_age 32 --trainval --save_results
#cd ..
